...
// and call `eucleia_enable_github`. This build is configured by environment
...
const serverInfo = { name: "eucleia", version: "0.0.0" };

const githubTool = {
  name: "eucleia_enable_github",
  description:
